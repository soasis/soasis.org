...
<a id="fnref-myrrlyn"></a>Normally, the fix to this is easy: the compiler can make the `nullptr` representation something like `0x55555555`. But sometimes, the compiler doesn't exactly do that, as [Myrrlyn <sup>1</sup>](#fn-myrrlyn) explains...
